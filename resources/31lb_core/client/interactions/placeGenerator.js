...
export const PresetList = {
    ...
    tattoo: { title: "Tattostudio", blip_icon: 75, banner: "shopui_title_tattoos" },
};
export function startPlaceGen(preset) {
    ...
    let unlockPosSameAsMarker = new NativeUI.UIMenuCheckboxItem("Position des Entsperrkreises", true, "Haken setzen wenn die Position der Entsperrung gleich ist, wie der Marker.");
...
function randomFunction() {
    let alphabet = 'abcdefghijklmnopqrstuvwxyz', serialLengthAlphabet = 12, randomSerialAlphabet = "", i, randomNumber;
        ...
        if (colshapeMeta.type == "interaction") {
            ...
            if (unlocked_places.includes(colshapeMeta.id)) {
                ...
                if (colshapeMeta.blip_color != null) {
                    ...
                    native.setBlipRouteColour(b, colshapeMeta.blip_color);
                }
