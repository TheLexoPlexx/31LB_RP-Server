...
export default class Weather {
    ...
    init() {
        ...
        this.interval = setInterval(() => this.initWeatherData(), 900000);
    }
    syncNewData() {
        if (alt.Player.all.length !== 0) {
            this.currentDate = new Date();
    ...
    setDate(player) {
        player.setDateTime(this.currentDate.getDate(), this.currentDate.getMonth(), this.currentDate.getFullYear(), this.currentDate.getHours(), this.currentDate.getMinutes(), this.currentDate.getSeconds());
    }
