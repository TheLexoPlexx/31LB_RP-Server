...
const game = require("natives");
const NativeUI = require("./includes/NativeUI/NativeUI");
...
let dynamicKickPlayerItem = new NativeUI.UIMenuDynamicListItem('Kick Player:', onDynamicPlayerKickItemChange, `Choose player to kick.`, () => players[0] // First player name to be selected
);
...
let dynamicListItem = new NativeUI.UIMenuDynamicListItem('Player X Position:', onDynamicListItemChange, // This is called every list item change
`Change Players X position.`, () => alt.Player.local.pos.x.toFixed(2) // This is called once on initial menu list item draw / menu opening 
);
